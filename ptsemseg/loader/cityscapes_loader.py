...
class cityscapesLoader(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        #print("img_before", img.shape)

        lbl = m.imread(lbl_path)
        lbl = self.encode_segmap(np.array(lbl, dtype=np.uint8))
        #print("lbl_before", lbl.shape)
        ...
        #print("img_after_1", img.shape)
        #img = torch.mean(img,dim=0,keepdim=True)   ##### only for mwcnn!!!!!
        #print("img_after_2", img.shape)
        #print("lbl_after", lbl.shape)
