...
# FOR GATE (to be included in new Gated-MWCNN... NOTE: remove once working)
from torch.nn.modules.utils import _pair
from torch.nn.modules.conv import _ConvNd
import mynn

# db_coefs = w = pywt.Wavelet('db2').dec_lo
...
def dwt_init_db2(x):
    x_LL, (x_LH, x_HL, x_HH) = pywt.dwt2(x, 'db2')
    return torch.cat((x_LL, x_HL, x_LH, x_HH), 1)

def iwt_init_db2(x):
    return pywt.idwt2(x, 'db2')
