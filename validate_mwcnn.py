...
def validate(cfg, args):
    ...
    for i, (images, labels) in enumerate(valloader):
        ...
        if args.measure_time:
            ...
            time = pred.shape[0] / elapsed_time
            print(
                "Inference time \
    ...
    print("count", count)
    print("overall_time", np.mean(overall_time))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="configs/gated_mwcnn_cityscapes.yml",
    ...
    parser.add_argument(
        ...
        default = "runs/gated_mwcnn_cityscapes/batchsize2_gmwcnn_final/gated_mwcnn_cityscapes_best_model.pkl",
